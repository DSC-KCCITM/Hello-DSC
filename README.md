...
### Step 6:
In your  file manager/terminal navigate to the downloaded repo. Open the sub-directory Hello_DSC/contributers. and create a new .md file with your username as the filename with .md extension.
